  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden bg-white">
        ...
        >
          <div className="bg-white p-8 rounded-3xl shadow-2xl border border-blue-100 max-w-sm">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-blue-900">Banglore to Hyderabad</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-blue-400" />
                <span className="text-gray-600">Niloufer-Cafe-Hitech-city</span>
              </div>
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-blue-600" />
                <span className="text-gray-600">Church-Street</span>
              </div>
              <div className="pt-4 border-t flex justify-between items-center">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-blue-200 border-2 border-white flex items-center justify-center text-[10px] font-bold text-blue-600">
                      JD
                    </div>
                  ))}
                </div>
                <p className="text-blue-600 font-bold">₹295</p>
              </div>
            </div>
          </div>
        </motion.div>
